...
<div class="container pt-4">
	<form action="/user/editdone" method="post">
	<div class="form-group row"  style="display:none;">
	    <p class="font-weight-bold col-sm-2 col-form-label">User ID</p>
	    <div class="col-sm-7">
	      <input type="text" class="form-control" value="${u.getUserID()}" name="UserID">
	    </div>
	  </div>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-7">
	      <input type="text" class="form-control" pattern="[0-9]{10}" title="Mobile number should be of 10 digits" value="${u.getPhoneNumber()}" name="PhoneNumber">
	    </div>
	  </div>
	  <div class="form-group row">
